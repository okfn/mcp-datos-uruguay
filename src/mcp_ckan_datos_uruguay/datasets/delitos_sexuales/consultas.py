...
SOURCE_URL = "https://catalogodatos.gub.uy/dataset/arce-datos-historicos-de-compras"


def _empty_result(label):
    return CallToolResult(
        content=[TextContent(type="text", text=f"No se encontraron eventos {label}.")],
        structuredContent={"sources": [SOURCE_URL]},
    )
...
def tendencia_anual(departamento=None, tipo_delito=None) -> DataToolOutput:
...
def eventos_por_departamento(anio=None, tipo_delito=None) -> DataToolOutput:

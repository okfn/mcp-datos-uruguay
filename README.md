...
Esto está listo para ejecutarse con el servidor OKFN MCP definido en https://github.com/okfn/mcp-server.
...
2. Configura el `engine` adecuado. Lee sobre ellos en https://github.com/okfn/mcp-server/tree/main/src/mcp_server/engines
